...
- ### [There are 10 courses in this Professional Certificate](#10courses)
  ...
  - #### [Course 5: Python Project for Data Science](#course5)
  - #### [Course 6: Databases and SQL for Data Science with Python](#course6)
...
- **Course 3: Data Science Methodology** <a class="anchor" id="course3"></a>
...
- **Course 4: Python for Data Science, AI, & Development** <a class="anchor" id="course4"></a>
...
- **Course 5: Python Project for Data Science** <a class="anchor" id="course5"></a>
  - This mini-course is intended to for you to demonstrate foundational Python skills for working with data. The completion of this course involves working on a hands-on project where you will develop a simple dashboard using Python.
- **Course 6: Databases and SQL for Data Science with Python** <a class="anchor" id="course6"></a>
